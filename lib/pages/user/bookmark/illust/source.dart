...
class UserIllustBookmarkListSource extends DataSourceBase<Illust> {
  final int id;
  final Restrict restrict;

  UserIllustBookmarkListSource(this.id, this.restrict);

  final api = Get.find<ApiClient>();

  @override
  Future<List<Illust>> init(CancelToken cancelToken) {
    return api.getUserIllustBookmarkPage(id, restrict: restrict, cancelToken: cancelToken).then((result) {
