...
class Utils {
  ...
  static String replaceImageSource(String url) {
    return url.replaceFirst('i.pximg.net', Get.find<SettingsService>().imageSource);
  }

  static String getPreviewUrl(ImageUrls imageUrls) {
    return Get.find<SettingsService>().previewQuality ? imageUrls.large : imageUrls.medium;
  }
