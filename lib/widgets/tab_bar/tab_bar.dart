...
class _IndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    /// 改动
    final Rect fromRect = indicatorRect(size, from, ltr ? (index - value) : (value - index));
...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _TabBarWidgetState tabBar;
...
class _TabBarWidgetState extends State<TabBarWidget> {
  ...
  void _initIndicatorPainter(EdgeInsetsGeometry? adjustedPadding, TabBarTheme tabBarTheme) {
    _indicatorPainter = !_controllerIsValid
        ...
        : _IndicatorPainter(
            ...
            labelPadding: adjustedPadding ?? widget.labelPadding ?? tabBarTheme.labelPadding ?? kTabLabelPadding,
            tabKeys: _tabKeys,
...
class RRecTabIndicator extends Decoration {
  const RRecTabIndicator({
    ...
    this.radius = 0,
    this.color = const Color(0xFFFF6289),
  });
