...
class I18nTranslations extends Translations {
  ...
  final Map<String, Map<String, String>> _keys = {
    ...
    'ru_RU': {
      ...
      I18n.updateLanguageExpansionHint: 'Обновите пакеты языковых расширений %s. Перезапустите приложение, чтобы активировать его.',
      I18n.noUpdateLanguageExpansionHint: 'Нет пакетов языковых расширений, которые нужно обновлять',
