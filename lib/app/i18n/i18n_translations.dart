...
class I18nTranslations extends Translations {
  ...
  final Map<String, Map<String, String>> _keys = {
    'zh_CN': {
      ...
      I18n.loadFromGitHub: '从GitHub加载(需要重启APP)',
    ...
    'ru_RU': {
      ...
      I18n.updateLanguageExpansionHint: 'Отсутствие языковых пакетов расширения, которые необходимо обновлять',
      I18n.noUpdateLanguageExpansionHint: 'Обновить %s языковую пачку расширений Перезапустите приложение для активации',
