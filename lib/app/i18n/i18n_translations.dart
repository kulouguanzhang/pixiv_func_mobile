...
class I18nTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ja_JP': {
          ...
          I18n.downloaderPageTitle: 'ダウンロードタスク',
          ...
          I18n.previewQualitySettingsPageTitle: '詳細ページ時画質',
          I18n.scaleQualitySettingsPageTitle: '全画面時画質',
          ...
          I18n.register: '登録',
          I18n.login: 'ログイン',
          I18n.localReverseProxy: 'ローカル リバースプロキシ',
          I18n.reverseProxyHint: 'Pixivに登録・ログインできない場合は、ローカル リバースプロキシを利用することをお勧めします。',
          ...
          I18n.loginAgree: 'ログインすると、利用規約に同意したものとみなします',
          ...
          I18n.searchTargetPartialMatchForTags: 'タグ(部分)',
          I18n.searchTargetExactMatchForTags: 'タグ(完全)',
          I18n.searchTargetTitleAndCaption: 'タイトル・キャプション',
          I18n.searchTargetText: '本文',
          I18n.searchTargetKeyword: 'キーワード',
          I18n.useCustomImageSource: 'カスタム画像ソースを使用する',
          ...
          I18n.searchImageStatus429Hint: '現在のIPは、saunaoの未登録ユーザーの1日の上限である50回を超えています',
        },
        'ru_RU': {
